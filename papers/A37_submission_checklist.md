...
| Abstract | **251 words** | **250 max** | ⚠️ over by 1 word, *and* unstructured (see #2) |
...
|---|---|---|---|
| 1 | **Word limit** — full papers "normally up to 9,000 words, exclusive of notes and references"; shorter articles 5,000 | ✅ | Body is ~3,143 words. Length is a non-issue; if anything the paper is short for the full-paper class — see ⟦MG⟧ decision #4 in the [cover letter](https://github.com/drdhaval2785/SanskritSpellCheck/blob/master/papers/A37_cover_letter.md). |
| 2 | **Structured abstract, 250 words max, five mandatory sub-headings** — Purpose; Design/methodology/approach; Findings; Originality; Contribution to the field of Digital Humanities | 🔴 | The current abstract is a **single 251-word narrative paragraph with no sub-headings**. This is the largest single piece of remaining work: it must be rewritten into the five mandatory sections, and sub-headings consume words, so expect to cut ~40–60 words of prose to land under 250. Three optional sub-headings (research limitations/implications, practical, social) may be added. |
