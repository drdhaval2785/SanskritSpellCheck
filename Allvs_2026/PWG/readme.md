...
- [AllvsPWG-priority.txt](AllvsPWG-priority.txt) — **verify-first list (99)**: the
  non-rcc anomalies, with clickable [report](AllvsPWG-priority.html). **Start here.**
- [AllvsPWG-signal.txt](AllvsPWG-signal.txt) — full review pool (107) = priority +
  post-repha; all suspects in ≥1 general dictionary.
- [AllvsPWG-gemination.txt](AllvsPWG-gemination.txt) — **post-repha subset (8)**:
  `r`+doubled-consonant variants ([report](AllvsPWG-gemination.html)). **Low priority**
