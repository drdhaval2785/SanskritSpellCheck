...
[triage_suspects.py](https://github.com/drdhaval2785/SanskritSpellCheck/blob/master/triage_suspects.py)): only **9** suspects, all clear
...
## Files
- [AllvsMW72-gemination.txt](https://github.com/drdhaval2785/SanskritSpellCheck/blob/master/Allvs_2026/MW72/AllvsMW72-gemination.txt) — **the review list (9)**:
  post-repha variants, with clickable [report](https://github.com/drdhaval2785/SanskritSpellCheck/blob/master/Allvs_2026/MW72/AllvsMW72-gemination.html). Note these
...
- [AllvsMW72.txt](https://github.com/drdhaval2785/SanskritSpellCheck/blob/master/Allvs_2026/MW72/AllvsMW72.txt) — full raw 15,402-suspect list, kept so the triage
